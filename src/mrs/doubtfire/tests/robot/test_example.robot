...
#
#  $ bin/test -s mrs.doubtfire -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src mrs.doubtfire.testing.MRS_DOUBTFIRE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/mrs/doubtfire/tests/robot/test_example.robot
#
